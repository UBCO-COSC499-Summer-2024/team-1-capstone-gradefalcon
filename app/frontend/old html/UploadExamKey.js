...
<head>
    ...
    <title>GradeFalcon Upload Answer Key</title>
    ...
    <script>
        function handleFileSelect(event) {
            ...
            if (file && file.type === "application/pdf") {
                ...
                pdfDisplay.querySelector('iframe').src = fileURL;
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            importBtn.addEventListener('click', () => resetUpload());
...
<body>
    <div class="main-content">
        ...
        <section class="upload-key">
            ...
            <a href="ExamControls.html" class="btn-confirm">Confirm</a>
        </section>
    </div>
</body>
</html>
