...
const UploadExamKey = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center gap-4 w-full">
      <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed shadow-sm p-6 bg-white w-full h-[200vh]"> {/* Increased height */}
        {!fileURL ? (
          <div className="flex flex-col items-center gap-1 text-center w-full h-full"> {/* Ensure full height */}
      ...
      <div className="flex gap-2 w-full mt-4"> {/* Adjusted spacing */}
